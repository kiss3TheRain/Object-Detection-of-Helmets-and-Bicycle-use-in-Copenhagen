...
parser.add_argument("--image_folder", type=str, default="data/0/images", help="path to dataset")
...
for epoch in range(opt.epochs):
    for batch_i, (_, imgs, targets) in enumerate(dataloader):
        ...
        train_losses = "[Epoch %d/%d, Batch %d/%d] [Losses: x %f, y %f, w %f, h %f, conf %f, cls %f, total %f, recall: %.5f, precision: %.5f]"% (
                epoch,
                opt.epochs,
                batch_i,
                len(dataloader),
        ...
        with open(opt.checkpoint_dir + "/losses.txt", "a") as t:
            t.write(train_losses + "\n")
